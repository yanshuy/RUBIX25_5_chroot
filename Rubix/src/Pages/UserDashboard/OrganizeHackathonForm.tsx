...
export const calculateTotalProgress = (tabProgresses) => {
    const totalProgress = Object.values(tabProgresses).reduce(
...
export function OrganizeHackathonForm() {
    ...
    const onSubmit = async (values: any) => {
        ...
        try {
            ...
            const response = await fetch(
                `https://live-merely-drum.ngrok-free.app/api/core/hackathons/`,
                {
                    method: "POST",
                    headers: {
    ...
    >((props, ref) => (
        <input
            ref={ref}
            className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 shadow-sm transition-colors duration-200 focus:border-black focus:outline-none focus:ring-1 focus:ring-black"
    ...
    >((props, ref) => (
        <textarea
            ref={ref}
            className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 shadow-sm transition-colors duration-200 focus:border-black focus:ring-1 focus:ring-black"
            onFocus={(e) => (activeInputRef.current = e.target)}
            {...props}
        />
    ));
    ...
    const Button = ({
        ...
        <button
            className={cn(
                "inline-flex justify-center rounded-lg border border-transparent px-6 py-2 text-sm font-medium shadow-md",
        ...
        return (
            <div className="flex flex-wrap gap-2 rounded-lg border border-gray-300 p-3">
                ...
                <input
                    ...
                    className="flex-grow border-none text-sm shadow-none focus:outline-none focus:ring-0 focus:ring-black"
        ...
        return (
            <div className="relative">
                <button
                    ...
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 text-left shadow-sm transition-colors duration-200 focus:border-black focus:outline-none focus:ring-1 focus:ring-black"
                >
                    {value ? (
                    ...
                    <CalendarIcon className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 transform text-gray-400" />
                </button>
                {isOpen && (
                    <div className="absolute z-10 mt-1 w-full rounded-lg border border-gray-200 bg-white shadow-lg">
                        <input
                            type="datetime-local"
                            className="block w-full rounded-lg border px-4 py-2 text-gray-900 focus:border-black focus:ring-1 focus:ring-black"
                            value={value || ""}
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    >
                        <Input
                            {...form.register("totalParticipants")}
                            type="number"
                        />
                    </FormField>
                </div>
    ...
    return (
        <div className="p-10">
            <div className="overflow-hidden bg-white p-10 sm:rounded-lg">
                <SetupHeader
...
const SetupHeader = ({
    ...
    return (
        <div className="w-full border-b border-slate-400 bg-white">
            <div className="mx-auto max-w-7xl p-4">
                <button
                    ...
                    className="mb-6 flex items-center text-blue-600 transition-colors hover:text-blue-700"
                >
                ...
                <div className="grid grid-cols-3 items-center gap-8">
                    <div className="col-span-1">
                        ...
                        <p className="text-gray-600">
                            ...
                            <a
                                href="mailto:community@devfolio.co"
                    ...
                    <div className="col-span-1">
                        <Button
                            ...
                            className="h-12 w-full bg-blue-100 text-blue-900 hover:bg-blue-200 disabled:opacity-50"
                        >
                            Finish Setup
                        </Button>
                        <p className="mt-2 text-center text-sm text-gray-500">
                            Complete set up 100% to proceed.
                        </p>
                    </div>
                </div>
            </div>
